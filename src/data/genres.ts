...
// we can copy the genres list from the games server to our App and delivery with it at deployment. it´s
// --- enough to look at the genres requests under network preview and copy the results here in number >-(1)->.

// 1.- To do this, we´ll first create a new module called 'genres.ts' (this one) under a new folder 
// --- called 'data'

// 2.- The go to the 'useGenres' cause we no longer need to ask for a genre fetch to the 'useData' hook
// >-(2)->

// TESTING OUR APP.- Good! 

// END OF LESSON.- Now we can do the same with platforms, so it´s an another excercise to do
// --- commit our code with name "36: Shipping genres as static data"
